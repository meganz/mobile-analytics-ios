...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AlbumItemSelected")))
@interface MEGAAOSAlbumItemSelected : MEGAAOSBase
- (instancetype)initWithSelectionType:(MEGAAOSAlbumItemSelectedSelectionType *)selectionType __attribute__((swift_name("init(selectionType:)"))) __attribute__((objc_designated_initializer));
@property (readonly) MEGAAOSAlbumItemSelectedSelectionType *selectionType __attribute__((swift_name("selectionType")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AlbumItemSelected.SelectionType")))
@interface MEGAAOSAlbumItemSelectedSelectionType : MEGAAOSKotlinEnum<MEGAAOSAlbumItemSelectedSelectionType *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) MEGAAOSAlbumItemSelectedSelectionType *single __attribute__((swift_name("single")));
@property (class, readonly) MEGAAOSAlbumItemSelectedSelectionType *multiadd __attribute__((swift_name("multiadd")));
@property (class, readonly) MEGAAOSAlbumItemSelectedSelectionType *multiremove __attribute__((swift_name("multiremove")));
+ (MEGAAOSKotlinArray<MEGAAOSAlbumItemSelectedSelectionType *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<MEGAAOSAlbumItemSelectedSelectionType *> *entries __attribute__((swift_name("entries")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AlbumItemSelectedEvent")))
@interface MEGAAOSAlbumItemSelectedEvent : MEGAAOSBase <MEGAAOSItemSelectedEventIdentifier>
- (instancetype)initWithSelectionType:(MEGAAOSAlbumItemSelectedSelectionType *)selectionType __attribute__((swift_name("init(selectionType:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSString *eventName __attribute__((swift_name("eventName")));
@property (readonly) NSDictionary<NSString *, id> *info __attribute__((swift_name("info")));
@property (readonly) int32_t uniqueIdentifier __attribute__((swift_name("uniqueIdentifier")));
