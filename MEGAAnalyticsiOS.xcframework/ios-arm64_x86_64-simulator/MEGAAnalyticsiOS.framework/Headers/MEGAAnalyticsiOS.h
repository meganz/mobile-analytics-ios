...
@interface MEGAAOSPlaySlideshowMenuToolbar : MEGAAOSBase
- (instancetype)initWithEntryPoint:(MEGAAOSPlaySlideshowMenuToolbarSlideshowEntryPoint *)entryPoint __attribute__((swift_name("init(entryPoint:)"))) __attribute__((objc_designated_initializer));
@property (readonly) MEGAAOSPlaySlideshowMenuToolbarSlideshowEntryPoint *entryPoint __attribute__((swift_name("entryPoint")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PlaySlideshowMenuToolbar.SlideshowEntryPoint")))
@interface MEGAAOSPlaySlideshowMenuToolbarSlideshowEntryPoint : MEGAAOSKotlinEnum<MEGAAOSPlaySlideshowMenuToolbarSlideshowEntryPoint *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) MEGAAOSPlaySlideshowMenuToolbarSlideshowEntryPoint *clouddrive __attribute__((swift_name("clouddrive")));
@property (class, readonly) MEGAAOSPlaySlideshowMenuToolbarSlideshowEntryPoint *folderlink __attribute__((swift_name("folderlink")));
@property (class, readonly) MEGAAOSPlaySlideshowMenuToolbarSlideshowEntryPoint *timeline __attribute__((swift_name("timeline")));
@property (class, readonly) MEGAAOSPlaySlideshowMenuToolbarSlideshowEntryPoint *albumcontent __attribute__((swift_name("albumcontent")));
+ (MEGAAOSKotlinArray<MEGAAOSPlaySlideshowMenuToolbarSlideshowEntryPoint *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<MEGAAOSPlaySlideshowMenuToolbarSlideshowEntryPoint *> *entries __attribute__((swift_name("entries")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SlideshowSettingRepeatButton")))
@interface MEGAAOSSlideshowSettingRepeatButton : MEGAAOSBase
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SlideshowSettingRepeatButtonEvent")))
@interface MEGAAOSSlideshowSettingRepeatButtonEvent : MEGAAOSBase <MEGAAOSButtonPressedEventIdentifier>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)slideshowSettingRepeatButtonEvent __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MEGAAOSSlideshowSettingRepeatButtonEvent *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *buttonName __attribute__((swift_name("buttonName")));
@property (readonly) NSString * _Nullable dialogName __attribute__((swift_name("dialogName")));
@property (readonly) NSString *eventName __attribute__((swift_name("eventName")));
@property (readonly) NSString * _Nullable screenName __attribute__((swift_name("screenName")));
