...
__attribute__((swift_name("AccountNotificationCentreEntryDisplayed")))
@protocol MEGAAOSAccountNotificationCentreEntryDisplayed
@required
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AccountNotificationCentreEntryDisplayedEvent")))
@interface MEGAAOSAccountNotificationCentreEntryDisplayedEvent : MEGAAOSBase <MEGAAOSGeneralEventIdentifier>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)accountNotificationCentreEntryDisplayedEvent __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MEGAAOSAccountNotificationCentreEntryDisplayedEvent *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *eventName __attribute__((swift_name("eventName")));
@property (readonly) NSDictionary<NSString *, id> *info __attribute__((swift_name("info")));
@property (readonly) int32_t uniqueIdentifier __attribute__((swift_name("uniqueIdentifier")));
@end
