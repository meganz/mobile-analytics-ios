...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SearchDateAddedFilterClicked")))
@interface MEGAAOSSearchDateAddedFilterClicked : MEGAAOSBase
- (instancetype)initWithDateOption:(NSString *)dateOption __attribute__((swift_name("init(dateOption:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSString *dateOption __attribute__((swift_name("dateOption")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SearchDateAddedFilterClickedEvent")))
@interface MEGAAOSSearchDateAddedFilterClickedEvent : MEGAAOSBase <MEGAAOSItemSelectedEventIdentifier>
- (instancetype)initWithDateOption:(NSString *)dateOption __attribute__((swift_name("init(dateOption:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSString *eventName __attribute__((swift_name("eventName")));
@property (readonly) NSDictionary<NSString *, id> *info __attribute__((swift_name("info")));
@property (readonly) int32_t uniqueIdentifier __attribute__((swift_name("uniqueIdentifier")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SearchFileTypeOptionClicked")))
@interface MEGAAOSSearchFileTypeOptionClicked : MEGAAOSBase
- (instancetype)initWithTypeOption:(NSString *)typeOption __attribute__((swift_name("init(typeOption:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSString *typeOption __attribute__((swift_name("typeOption")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SearchFileTypeOptionClickedEvent")))
@interface MEGAAOSSearchFileTypeOptionClickedEvent : MEGAAOSBase <MEGAAOSItemSelectedEventIdentifier>
- (instancetype)initWithTypeOption:(NSString *)typeOption __attribute__((swift_name("init(typeOption:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSString *eventName __attribute__((swift_name("eventName")));
@property (readonly) NSDictionary<NSString *, id> *info __attribute__((swift_name("info")));
@property (readonly) int32_t uniqueIdentifier __attribute__((swift_name("uniqueIdentifier")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SearchLastModifiedOptionClicked")))
@interface MEGAAOSSearchLastModifiedOptionClicked : MEGAAOSBase
- (instancetype)initWithDateOption:(NSString *)dateOption __attribute__((swift_name("init(dateOption:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSString *dateOption __attribute__((swift_name("dateOption")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("SearchLastModifiedOptionClickedEvent")))
@interface MEGAAOSSearchLastModifiedOptionClickedEvent : MEGAAOSBase <MEGAAOSItemSelectedEventIdentifier>
- (instancetype)initWithDateOption:(NSString *)dateOption __attribute__((swift_name("init(dateOption:)"))) __attribute__((objc_designated_initializer));
@property (readonly) NSString *eventName __attribute__((swift_name("eventName")));
@property (readonly) NSDictionary<NSString *, id> *info __attribute__((swift_name("info")));
@property (readonly) int32_t uniqueIdentifier __attribute__((swift_name("uniqueIdentifier")));
